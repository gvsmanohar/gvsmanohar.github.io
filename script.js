...
yesButton.addEventListener("click", () => {
    ...
    var confettiSettings = { target: confettiElement, max: 729, size: 1, animate: true, props: ['circle', 'square', 'triangle', 'line'], colors: [
            [165, 104, 246],
            [230, 61, 135],
            [0, 199, 228],
            [253, 214, 126]
    ...
    p.innerText = "Semma Enga polam sollu appo ammu?😉. Love Bubu ❤️";
